            ...
            Column(Modifier.fillMaxSize()) {
                ...
                when (uiState.destination) {
                    ...
                    AppDestination.AdminConsole -> AdminConsoleScreen(
                        ...
                        nodes = uiState.adminNodes,
                        edges = uiState.adminEdges,
                        documents = uiState.adminDocuments,
                        formulas = uiState.adminFormulas,
                        ocrTasks = uiState.adminOcrTasks,
                        auditLogs = uiState.adminAuditLogs,
                        alerts = uiState.adminAlerts,
                        checks = uiState.adminChecks,
                        feedback = uiState.adminFeedback,
                        conversationUsers = uiState.adminConversationUsers,
                        conversations = uiState.adminConversations,
                        selectedConversationUserId = uiState.adminConversationUserId,
                        ...
                        onRoleChange = viewModel::changeAdminRole,
                        ...
                        onDeleteEdge = viewModel::deleteAdminEdge,
                        onReviewFormula = viewModel::reviewAdminFormula,
                        onRetryOcr = viewModel::retryAdminOcr,
                        onCancelOcr = viewModel::cancelAdminOcr,
                    ...
                    AppDestination.Graph -> KnowledgeGraphScreen(
                        ...
                        canGoBack = uiState.graphNavigationHistory.isNotEmpty(),
                        onGoBack = viewModel::goBackGraph,
                        ...
                        onBackToSubjects = viewModel::exitKnowledgeScope,
                    )
