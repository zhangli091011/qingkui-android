...
data class AdminUserUpdateRequest(val username: String? = null, val email: String? = null, val nickname: String? = null, @SerializedName("tenant_id") val tenantId: String? = null)
data class AdminCreditAdjustmentRequest(val amount: Int, val reason: String)
data class AdminConversationUserDto(@SerializedName("user_id") val userId: String, val username: String, val nickname: String, @SerializedName("conversation_count") val conversationCount: Int = 0, @SerializedName("message_count") val messageCount: Int = 0, @SerializedName("latest_activity_at") val latestActivityAt: String? = null)
data class AdminConversationMessageDto(val id: String, val role: String, val content: String, @SerializedName("created_at") val createdAt: String = "", @SerializedName("structured_content") val structuredContent: Map<String, Any?>? = null)
data class AdminConversationDto(val id: String, @SerializedName("user_id") val userId: String, val username: String = "", val title: String = "", val mode: String = "knowledge", val subject: String? = null, @SerializedName("created_at") val createdAt: String = "", @SerializedName("updated_at") val updatedAt: String = "", val messages: List<AdminConversationMessageDto> = emptyList())
